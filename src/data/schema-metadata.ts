...
export const schemaMetadata: TableMetadata[] = [
  {
    ...
    columns: [
      ...
      { field: "title", label: "Civilite", type: "text" },
      { field: "first_name", label: "Prenom", type: "text" },
      { field: "last_name", label: "Nom", type: "text" },
      { field: "email", label: "Email", type: "text" },
      { field: "mobile_phone", label: "Telephone mobile", type: "text" },
      { field: "business_phone", label: "Telephone professionnel", type: "text" },
      { field: "home_phone", label: "Telephone domicile", type: "text" },
      ...
      { field: "end_date", label: "Date de fin", type: "date" },
      { field: "date_of_birth", label: "Date de naissance", type: "date" },
      { field: "is_inactive", label: "Inactif", type: "boolean" },
      { field: "nationality", label: "Nationalite", type: "text" },
      { field: "national_registration", label: "N° Registre National", type: "text" },
      { field: "inami_number", label: "N° INAMI", type: "text" },
      { field: "iban", label: "IBAN", type: "text" },
      { field: "bic", label: "BIC", type: "text" },
      ...
      { field: "distance_to_home", label: "Distance domicile (km)", type: "number" },
  ...
  },
  {
    ...
    columns: [
      ...
      { field: "mission", label: "Mission / description", type: "text" },
      { field: "rtt_group_id", label: "Groupe RTT", type: "number" },
    ],
    foreignKeys: [],
  },
  {
  ...
  },
  {
    ...
    columns: [
      ...
      { field: "text_color_hex", label: "Couleur texte", type: "text" },
      { field: "time_unit", label: "Unite de temps", type: "text" },
      { field: "sort_order", label: "Ordre de tri", type: "number" },
    ],
    foreignKeys: [],
  },
  {
  ...
  },
  {
    ...
    columns: [
      ...
      { field: "created_at", label: "Date creation", type: "date" },
    ],
    foreignKeys: [],
  },
  {
  ...
  },
  {
    ...
    columns: [
      ...
      { field: "requester_id", label: "Demandeur", type: "number" },
      { field: "priority", label: "Priorite", type: "text" },
      { field: "completed_at", label: "Date completion", type: "date" },
    ],
    foreignKeys: [
      { fromField: "requester_id", toTable: "employees", toField: "id" },
    ],
  },
];
